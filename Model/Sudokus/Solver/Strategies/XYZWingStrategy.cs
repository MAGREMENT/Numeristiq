...
public class XYZWingStrategy : SudokuStrategy
{
    ...
    public XYZWingStrategy() : base(OfficialName, Difficulty.Medium, DefaultInstanceHandling) {}
    ...
    private bool Process(ISudokuSolverData solverData, int hingeRow, int hingeCol, int row1, int col1, int row2,
        int col2, int number)
    {
        foreach (var cell in SudokuUtility.SharedSeenCells(new Cell(hingeRow, hingeCol),
