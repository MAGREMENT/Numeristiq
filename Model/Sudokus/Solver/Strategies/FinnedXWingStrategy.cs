...
public class FinnedXWingStrategy : SudokuStrategy
{
    ...
    public FinnedXWingStrategy() : base(OfficialName, Difficulty.Hard, DefaultInstanceHandling){}
        ...
        IReadOnlyLinePositions normalPos, IReadOnlyLinePositions finnedPos, int number)
    {
        ...
        solverData.ChangeBuffer.Commit(new FinnedXWingReportBuilder(normalPos, normalRow, finnedPos,
        ...
        IReadOnlyLinePositions normalPos, IReadOnlyLinePositions finnedPos, int number)
    {
        ...
        if (!solverData.ChangeBuffer.NeedCommit()) return false;
        solverData.ChangeBuffer.Commit(new FinnedXWingReportBuilder(normalPos, normalCol,
...
public class FinnedXWingReportBuilder : IChangeReportBuilder<NumericChange, ISudokuSolvingState, ISudokuHighlighter>
{
