...
public class BUGStrategyRewrite : AbstractStrategy
{
    ...
    public BUGStrategyRewrite(int maxAdditionalCandidates) : base(OfficialName, StrategyDifficulty.Medium, DefaultBehavior)
    {
    ...
    public override void Apply(IStrategyManager strategyManager)
    {
        ...
        if(strategyManager.ChangeBuffer.NotEmpty()) strategyManager.ChangeBuffer.Commit(this,
            new BUGStrategyRewriteReportBuilder(additionalCandidates));
    }
}

public class BUGStrategyRewriteReportBuilder : IChangeReportBuilder
{
    private readonly List<CellPossibility> _additionalCandidates;

    public BUGStrategyRewriteReportBuilder(List<CellPossibility> additionalCandidates)
    {
