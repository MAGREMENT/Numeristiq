...
public class CellForcingNetStrategy : AbstractStrategy
{
    ...
    public override void Apply(IStrategyManager strategyManager)
    {
        for (int row = 0; row < 9; row++)
        {
            for (int col = 0; col < 9; col++)
            {
                ...
                var colorings = new ColoringDictionary<IChainingElement>[possAsArray.Length];
    ...
    private bool Process(IStrategyManager view, ColoringDictionary<IChainingElement>[] colorings, Cell current)
    {
...
public class CellForcingNetBuilder : IChangeReportBuilder
{
    ...
    public CellForcingNetBuilder(ColoringDictionary<IChainingElement>[] colorings, int row, int col,
        CellPossibility target, Coloring targetColoring, ILinkGraph<IChainingElement> graph)
    {
