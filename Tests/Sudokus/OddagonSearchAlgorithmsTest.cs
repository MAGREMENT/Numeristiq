...
public class OddagonSearchAlgorithmsTest
{
    ...
    public void Test()
    {
        ...
        solver.PreComputer.Graphs.ConstructSimple(SudokuConstructRuleBank.CellStrongLink,
            SudokuConstructRuleBank.CellWeakLink, SudokuConstructRuleBank.UnitWeakLink,
            SudokuConstructRuleBank.UnitStrongLink);
        var graph = solver.PreComputer.Graphs.SimpleLinkGraph;
